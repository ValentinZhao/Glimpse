...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliOtakuPresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliOtakuFragment;
...
public class OtakuDanceFragment extends BaseFragment implements IBilibiliOtakuFragment {

    IBilibiliOtakuPresenterImpl mIBilibiliOtakuPresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getOtaku_dance_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliOtakuPresenterImpl = new IBilibiliOtakuPresenterImpl(getContext(), this);
    ...
    private void loadCoverTopList() {
        ...
        mIBilibiliOtakuPresenterImpl.getOtakuTopList();
    }
}
