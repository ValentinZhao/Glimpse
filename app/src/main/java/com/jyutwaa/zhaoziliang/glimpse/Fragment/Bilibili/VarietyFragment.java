...
public class VarietyFragment extends BaseFragment implements IBilibiliIntegratedFragment {
    View mView;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_bilibili_variety, null);
        return mView;
    }
