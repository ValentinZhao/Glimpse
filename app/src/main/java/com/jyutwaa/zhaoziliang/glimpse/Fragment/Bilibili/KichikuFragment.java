...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliKichikuPresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliKichikuFragment;
...
public class KichikuFragment extends BaseFragment implements IBilibiliKichikuFragment {


    IBilibiliKichikuPresenterImpl mIBilibiliKichikuPresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getKichiku_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliKichikuPresenterImpl = new IBilibiliKichikuPresenterImpl(getContext(), this);
    ...
    private void loadCoverTopList() {
        ...
        mIBilibiliKichikuPresenterImpl.getKichikuTopList();
    }
}
