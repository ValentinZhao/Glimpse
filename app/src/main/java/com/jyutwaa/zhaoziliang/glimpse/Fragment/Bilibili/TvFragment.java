...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliTvPresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliTvFragment;
...
public class TvFragment extends BaseFragment implements IBilibiliTvFragment {

    LinearLayoutManager mLinearLayoutManager;
    RecyclerView.OnScrollListener mScrollListener;
    BaseBilibiliFragmentAdapter mAdapter;
    IBilibiliTvPresenterImpl mIBilibiliTvPresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getTv_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliTvPresenterImpl = new IBilibiliTvPresenterImpl(getContext(), this);
    ...
    private void loadEsportTopList() {
        if(mAdapter.getItemCount() > 0){
            mAdapter.clearData();
        }
        mIBilibiliTvPresenterImpl.getTvTopList();
    }
}
