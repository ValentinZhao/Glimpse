...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliSerialPresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliSerialFragment;
...
public class SerialFragment extends BaseFragment implements IBilibiliSerialFragment {

    IBilibiliSerialPresenterImpl mIBilibiliSerialPresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getSerial_cartoon_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliSerialPresenterImpl = new IBilibiliSerialPresenterImpl(getContext(), this);
    ...
    private void loadCoverTopList() {
        ...
        mIBilibiliSerialPresenterImpl.getSerialTopList();
    }
}
