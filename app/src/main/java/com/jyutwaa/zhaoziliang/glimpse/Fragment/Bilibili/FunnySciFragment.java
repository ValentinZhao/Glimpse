...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliFunnyPresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliFunnyFragment;
...
public class FunnySciFragment extends BaseFragment implements IBilibiliFunnyFragment {

    IBilibiliFunnyPresenterImpl mIBilibiliFunnyPresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getFunny_sci_human_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliFunnyPresenterImpl = new IBilibiliFunnyPresenterImpl(getContext(), this);
    ...
    private void loadCoverTopList() {
        ...
        mIBilibiliFunnyPresenterImpl.getFunnyTopList();
    }
}
