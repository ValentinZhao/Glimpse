...
import com.jyutwaa.zhaoziliang.glimpse.Presenter.presenterImpl.IBilibiliMoviePresenterImpl;
import com.jyutwaa.zhaoziliang.glimpse.Presenter.viewImpl.IBilibiliMovieFragment;
...
public class MovieFragment extends BaseFragment implements IBilibiliMovieFragment {

    IBilibiliMoviePresenterImpl mIBilibiliMoviePresenterImpl;
    ...
    public void updateList(TopListType topListType) {
        if(topListType != null){
            mAdapter.addItems(topListType.getMovie_list().getAllItems());
        }
    }
    ...
    private void initViewsAndLaunch() {
        mIBilibiliMoviePresenterImpl = new IBilibiliMoviePresenterImpl(getContext(), this);
    ...
    private void loadCoverTopList() {
        ...
        mIBilibiliMoviePresenterImpl.getMovieTopList();
    }
}
